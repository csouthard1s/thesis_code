...
def build_eegnet(chans, samples, nb_classes, pretrained_weights):
...
eegnet_model_onset = build_eegnet(chans=64, samples=128, nb_classes=1, pretrained_weights='/content/pretrain_onset.keras')
...
eegnet_model_chroma = build_eegnet(chans=64, samples=128, nb_classes=12, pretrained_weights='/content/pretrain_chroma.keras')
@register_keras_serializable()
